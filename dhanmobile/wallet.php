        ...
        <div class="container">
            <div class="row mt-4">
                <div class="col">
                    ...
                    <h3 class="mb-0 font-weight-normal">Points   <?php echo $row['commition']; ?></h3>
                ...
                <div class="swiper-slide pb-4">
                    <div class="container z-1 position-relative">
                        <div class="card bg-template shadow mt-4 h-200">
                         		  <?php 
			                                    	$mobile=$_SESSION['user'];
$query = "SELECT * FROM `transaction` as t JOIN nayesoch as n on n.tid=t.ORDERID WHERE pid='$mobile'";
$result = mysqli_query($connect, $query);
        ...
        ?>   
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                       <center> 
                                        <!--<p class="small text-mute mt-2">Date <?php echo  $row['TXNDATE']; ?></p></center>-->
                                    </div>
                                    <div class="col-12 mt-5">
                                       <center> <h5 class="font-weight-normal">Transaction Details.<?php echo $row['STATUS'];?></h5></center>
                                    </div>
                                    <div class="col-12">
                                        <br>
                                        <p>Amount : <?php echo $row['amount']; ?> <span class="float-right">Date:<?php echo $row['TXNDATE']; ?></span></p>
                                    </div>
                                </div>
                            </div>
                                              <?php } ?>
