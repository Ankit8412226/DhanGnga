		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<form method="post" action="" id="paytm_forms" class="form-horizontal text-center">
				    ...
				    <a class="btn btn-link" href="https://nayesochnayakadam.com/">Return Home </a>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
						<p>&copy; <?php echo date('Y');?> by <b><a href="https://rajmunnitechnology.com/">RajMunniTechnology.com</a></b>. All Rights Reserved.</p>
					</div>
				</div>
			</div>
		</section>
