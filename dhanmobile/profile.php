...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="withh=device-withh, initial-scale=1, shrink-to-fit=no, viewport-fit=cover, user-scalable=no">
...
<body>
    ...
    <div class="sidebar">
        <div class="mt-4 mb-3">
            <div class="row">
                <div class="col-auto">
                    <figure class="avatar avatar-60 border-0"><img src="../assets/images/photo/paid/<?php echo $row['image']; ?>" alt="Not Upload"></figure>
                </div>
  ...
  <div class="row">
            <div class="col">
                <div class="list-group main-menu">
                   ...
                   <!-- <a href="controls.php" class="list-group-item list-group-item-action"><i class="material-icons icons-raised">view_quilt<span class="new-notification"></span></i>Pages Controls</a>-->
    ...
    <div class="wrapper profilepage">
        ...
        <div class="header">
            <div class="row no-gutters">
                ...
                <div class="col-auto">
                    <a href="notification.php" class="btn  btn-link text-dark position-relative"><i class="material-icons">notifications_none</i><span class="counts">1+</span></a>
                </div>
            </div>
        </div>
        <!-- header ends -->
	 <?php
			...
			<div class="text-center">
                <div class="figure-profile shadow my-4">
                    ...
                    <!--<a href="profile-edit.php?id=<?php echo $row['pmid']; ?>" class="list-group-item list-group-item-action "><i class="material-icons icons-raised bg-primary">account_circle</i>Details</a>-->
               <!--      <a href="profile.php" class="list-group-item list-group-item-action "><i class="material-icons icons-raised bg-primary">settings</i>Setting</a>-->
				         
				            <a href="profile-edit.php?id=<?php echo $row['pmid']; ?>" class="btn btn-lg btn-default btn-block btn-rounded shadow"><span>Profile Details</span></a>
				            <a href="upload.php?id=<?php echo $row['pmid']; ?>" class="btn btn-lg btn-default btn-block btn-rounded shadow"><span>Upload Document</span></a>
...
<div class="footer">
    ...
    <div class="modal fade " id="colorscheme" tabindex="-1" role="dialog" aria-hitden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content ">
                <div class="modal-header theme-header border-0">
                    <h6 class="">Color Picker</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hitden="true">&times;</span>
                    </button>
                </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="atdmoney" tabindex="-1" role="dialog" aria-labelledby="atdmoenylabel" aria-hitden="true">
