...
<body>
    ...
    <div class="wrapper">
        <div class="header">
            <div class="row no-gutters">
                <div class="col-auto">
                    <a href="notification.php" class="btn  btn-link text-dark"><i class="material-icons">navigate_before</i></a>
                </div>
        ...
        <div class="container">
            <div class="card bg-template shadow mt-4 h-190">
                <div class="card-body">
                    <div class="row">
                        <div class="col-auto">
                            <figure class="avatar avatar-60"><img src="admin/<?php echo $row['image1'];?>" alt=""></figure>
                        </div>
                        <div class="col pl-0 align-self-center">
                            <h5 class="mb-1"><?php echo $row['p_name'];?> </h5>
                            <p class="text-mute "><?php echo $row['p_address'];?> <small class="float-right text-mute">3 days ago</small></p>
			 ...
			 <?php
												$mobile=$_SESSION['user'];
												$n_id=1;
                                    $query = "SELECT * FROM noti WHERE n_id='$n_id' and n_mobile = '$mobile'";
                                    $result = mysqli_query($connect, $query);
                                    $row = mysqli_fetch_assoc($result);
                                    ?>
        <div class="container top-100">
            <div class="card mb-4 shadow">
                <div class="card-body">
                    ...
                    <p class="text-secondary text-mute"><?php echo $row['n_massage']; ?>.</p>
                </div>
            </div>
        </div>
    ...
    <!-- nouislider js -->
    <script src="vendor/nouislider/nouislider.min.php"></script>

    <!-- chosen multiselect js -->
    <script src="vendor/chosen_v1.8.7/chosen.jquery.min.php"></script>
