...
<body>
    ...
    <div class="form-group">
        <input type="mobile" name="mobile" id="inputEmail" class="form-control form-control-lg text-center" placeholder="Mobile No" required autofocus>
    </div>
    ...
    <a href="signup.php" class="mt-4 d-block">Join Naye Soch Naya Kadam</a>

    <a href="../otp" class="mt-4 d-block">Forgot Password?</a>
</div>
<br>
<br>
<br>
