...
<body>
    ...
    <div class="sidebar">
        <div class="mt-4 mb-3">
            <div class="row">
                <div class="col-auto">
                    <figure class="avatar avatar-60 border-0"><img src="<?php echo $row['image'];?>" alt=""></figure>
                </div>
    ...
    <div class="wrapper">
        ...
        <div class="header">
            <div class="row no-gutters">
                ...
                <div class="col-auto">
                    <a href="notification.php" class="btn  btn-link text-dark position-relative"><i class="material-icons">notifications_none</i></a>
                </div>
            </div>
        </div>
        <!-- header ends -->
                        ...
                        <a class="list-group-item border-top active text-dark" href="">
                            <div class="row">
                                ...
                                <div class="col pl-0">
                                    ...
                                    <p class="small text-mute"><?php echo $row['details'];?></p>
                                </div>
<?php } ?>
                            </div>
                        </a>
