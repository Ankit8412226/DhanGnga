...
<!-- Mirrored from maxartkiller.com/website/Fimobile/Fimobile-HTML/wallet.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Dec 2019 13:37:14 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="swiper-container card-slide mb-2">
            <div class="swiper-wrapper">
			  <?php
                                    ...
                                    $query = "SELECT * FROM another  where ano_mobile='$mobile'";
        ...
        <div class="container mt-4">            
            <div class="card shadow border-0 mb-2">
                <div class="card-header bg-none">
                    <h6>Donate Flood victims</h6>
                </div>
                <div class="card-body pt-0">
                    <figure class="btn-rounded-10 overflow-hidden">
                        <img src="img/product1.jpg" alt="" class="mw-100">
                    </figure>
                    <div class="row">
                        <div class="col">
                            <h5 class="font-weight-normal mb-1">$ 10.00 </h5>
                            <p class="text-mute small text-secondary mb-2">Feed the flood victims</p>
            ...
            <div class="no-gutters">
                <div class="col-auto mx-auto">
                    <div class="row no-gutters justify-content-center">
                        ...
                        <div class="col-auto">
                            <a href="wallet.html" class="btn btn-link-default active">
