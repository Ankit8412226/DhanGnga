    ...
    <div class="wrapper pb-0">
        ...
        <div class="header">
            <div class="row no-gutters">
                <div class="col-auto">
                    <a href="index.php" onclick="index.php" class="btn  btn-link text-dark"><i class="material-icons">navigate_before</i></a>
                </div>
	...
	<form method="post" action="pgRedirect.php">
        ...
        <div class="container">
            ...
            <section class="jumbotron text-center mt-3 bg-white shadow-sm">
                <div class="container">
                    <h1 class="jumbotron-heading font-weight-normal">Transaction Succesful<b></b></h1>
                    <p class="lead"><br>
					</b>
                    <p class="text-secondary text-mute small"></p>
                    <p>
					                    <a href="index.php" class="btn btn-default btn-rounded shadow my-2"	>Back</a>
