	...
	<div class="col-12 col-md-6 col-lg-4 col-xl-4 pricing-table pricing-table--popular wow move-up">
								...
								<div class="pricing-table__inner">
                                    ...
                                    <div class="pricing-table__body">
										...
										$t = $_GET['id'];
										$u = $_GET['id2'];
										$query = "SELECT * FROM `type` as t join subcatogry as sb on sb.scid=t.scn where scn='$u'";
$result = mysqli_query($connect, $query);
while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
<a href="adv.php?id=<?php echo $row["t1"]; ?>&id2=<?php echo $row["scname"]; ?>" class="ht-btn  "><?php echo $row["t1"]; ?>                      </a>  
<br>
</br>
<?php
