                ...
                <div class="container">
                    <div class="row footer-widget-wrapper">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6 footer-widget">
                            ...
                            <ul class="footer-widget__list">
                                <li><a href="#" class="hover-style-link">Dhanganga Online Public Kendra</a></li>
                                <li><a href="#" class="hover-style-link">Dhanganga Associate</a></li>
                                <li><a href="#" class="hover-style-link">Dhanganga Physical Treatment Home</a></li>
                                <li><a href="#" class="hover-style-link">Dhanganga Store</a></li>
                                <li><a href="#" class="hover-style-link">Dhanganga Real Esate</a></li>
                                <li><a href="#" class="hover-style-link">Dhanganga Hire Services</a></li>
                                <li><a href="#" class="hover-style-link">Dhanganga Hire Vehicle</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-2 col-md-4 col-sm-6 footer-widget">
                            <h6 class="footer-widget__title mb-20">Quick links</h6>
                            <ul class="footer-widget__list">
                                <li><a href="#" class="hover-style-link">Book Services</a></li>
