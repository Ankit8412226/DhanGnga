...
if (isset($_POST['submit'])) {
    ...
    $txid=rand(1000,1000000);

	$filename = $_FILES['doc1']['name'];
	$tempname = $_FILES['doc1']['tmp_name']; 
	$folder = "assets/images/docu/".$filename; 
...
$date = date('d-m-y');
 ...
 $sql = "INSERT INTO `enquiry` (`ename`, `emobile`, `eemail`, `edept`, `subdept`, `amount`, `doc1`, `reference`, `mcomment`,`date`,`txid`) VALUES ( '$ename', '$emobile', '$eemail','$aaaa', '$subdept', '$amount', '$folder', '$reference', '$mcomment', '$date','$txid')";
    mysqli_query($connect, $sql) or die($sql);
 echo "<script>
window.location.href='payment.php?id=$aaaa&id2=$subdept';
</script>";
}
                                    ...
                                    <div class="contact-form__two">
                                        ...
                                        <div class="contact-input">
										  ...
										  <div class="contact-inner">
                                                ...
                                                <input name="amount" value="<?php echo $row['fee'];?>" type="hidden">
                                                <input name="subdept" value="<?php echo $row['scname'];?>" type="hidden">
                                                <input name="aaaa" value="<?php echo $row['scid'];?>" type="hidden">
											<p>IF Any Document Upload Here</p>
											<div class="contact-inner">
