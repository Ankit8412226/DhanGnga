...
<br>
  ...
  <!--========= Pricing Table Area Start ==========-->
            <div class="pricing-table-area section-space--pb_90 bg-gradient">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section-title-wrapper text-center section-space--mb_60 wow move-up">
                                    ...
                                    <h3 class="section-title">DhanGanga <span class="text-color-primary"> services.</span> </h3>
                                </div>
                            </div>
                        </div>
                    </div>
...
$query = "SELECT * FROM subcatogry where scid='$sid'";
	...
	<div class="col-12 col-md-6 col-lg-4 col-xl-4 pricing-table pricing-table--popular wow move-up">
                                <form class="contact-form"  action="document.php" enctype="multipart/form-data" method="post">

								<div class="pricing-table__inner">
                                    <div class="pricing-table__header">
                                        <h6 class="sub-title"><?php echo $row['scname'];?></h6>
                                        <div class="pricing-table__image">
                                            <img src="assets/images/logo/sai1 (1).png" class="img-fluid" alt="">
                                        </div>
                                        <div class="pricing-table__price-wrap">
                                            <h6 class="currency"></h6>
                                            <h6 class="price"><?php echo $row['fee'];?></h6><h4> <?php echo  $rup;?> </h4>
                                            <h6 class="period"><?php echo $row['time'];?></h6>
                                        <?php $doc= $row['doc'];?>
                                        <?php  $dty= $row['scname'];?>
										</div>
                                    </div>
...
<?php
										...
										if ($t == $v ) {
                                            ?>
                                            <br>
  echo "<script> location.href='joinfull.php'; </script>";
        exit;
        </br>
                                          <?php
										}
										...
										if ($t == $v ) {
                                            ?>
                                            <br>
  echo "<script> location.href='https://nayesochnayakadam.com/dhanmobile/login.php'; </script>";
        exit;
        </br>
                                          <?php
										}
										...
										if ($t == $v ) {
                                            ?>
                                            <br>
  echo "<script> location.href='aboutnsnk.php'; </script>";
        exit;
        </br>
                                          <?php
										}
										...
										if ($t == $v ) {
                                            ?>
                                            <br>
  echo "<script> location.href='terms.php'; </script>";
        exit;
        </br>
                                          <?php
										}
  ...
  echo "<script> location.href='aboutnsnk.php'; </script>";
        exit;
										...
										if ($t == $v ) {
                                            ?>
                                            <br>
  echo "<script> location.href='benifit.php'; </script>";
        exit;
        </br>
                                          <?php
										}
...
<?php
										...
										if ($t == $v ) {
                                            ?>
                                            <br>
  echo "<script> location.href='home.php?id=<?php echo $_POST['id'];?>&id2=<?php echo $_POST['id2'];?>'; </script>";
        exit;
        </br>
                                          <?php
										}
