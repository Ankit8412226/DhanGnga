                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section-title-wrapper text-center section-space--mb_60 wow move-up">
                                    ...
                                    <h3 class="section-title"><?php echo $row['sname'];?> <span class="text-color-primary">all services.</span> </h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="pricing-table-content-area">
                    <div class="container">
                        <div class="row pricing-table-one">
                              <?php 
							  $sid=$_GET['id'];
$query = "SELECT * FROM subcatogry where scsid='$sid'";
$result = mysqli_query($connect, $query);
								...
								<div class="pricing-table__inner">
                                    <div class="pricing-table__header">
                                        ...
                                        <div class="pricing-table__price-wrap">
                                            ...
                                            <h6 class="price"><?php echo $row['fee'];?></h6>
                                            <h6 class="period"><?php echo $row['time'];?></h6>
                                        </div>
                                    </div>
                                    <div class="pricing-table__body">
                                        <div class="pricing-table__footer">
                        <a href="plan.php?id=<?php echo $sid;?>&id2=<?php echo $row['scid'];?>" class="ht-btn  ht-btn-md ">Next</a>
										</div>
										<ul class="pricing-table__list text-left">
                                            <h6>आवश्यक दस्तावेज</h6>                                          
                                        </ul>
                                        <ul class="pricing-table__list text-left">
                                            <li><?php echo $row['doc'];?></li>                                          
                                        </ul>
                                    </div>
                                </div>
