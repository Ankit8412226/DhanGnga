  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
       ...
       <tbody>				  										<?php 
$a=0;
$query = "SELECT * FROM enquiry order by eid asc";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    ?>
                  ...
                  <tr>
                    ...
                    <td><img src="../<?php echo $row['doc1'];?>" class="img-fluid" alt="" style="width:200px;height:170px;"></td>
                    <td><?php echo $row['date']; ?></td>
                    <td><a href="deletedata.php?id=<?php echo $row['eid']; ?>"> <span class="btn btn-info">Delete</span></a></td>
