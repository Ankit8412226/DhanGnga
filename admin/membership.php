  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
       ...
       <tbody>				  										<?php 
$a=0;
$query = "SELECT * FROM member order by mid asc";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    ?>
                  ...
                  <tr>
                    ...
                    <td><img src="../<?php echo $row['image'];?>" class="img-fluid" alt="" style="width:100px;height:100px;"></td>
                   <td><img src="../<?php echo $row['image1'];?>" class="img-fluid" alt="" style="width:100px;height:100px;"></td>

                  <td><a href="deletemember.php?id=<?php echo $row['mid']; ?>"> <span class="btn btn-info">Delete</span></a></td>
