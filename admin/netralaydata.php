...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['pdept']; ?></td>
                    <td><?php echo $row['pmobile']; ?></td>
                    <td> <?php echo $row['pmassage']; ?></td>
                    <td><a href="deletenetra.php?id=<?php echo $row['enid']; ?>"> <span class="btn btn-info">Delete</span></a></td>
