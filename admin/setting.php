...
if (isset($_POST['submit'])) {
    ...
    // move_uploaded_file($tempname,$folder);
		$sql = " UPDATE admin  SET  name = '$name', email = '$email' , mobile='$mobile', password = '$password'  WHERE mobile = '$mobile'" ; 
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Change Profile Setting</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <?php
                ...
                <div class="card-body">
				  ...
				  <div class="form-group">
                    <div class="form-group">
                        ...
                        <input type="email" name="email" value="<?php echo $row['email'];?>" class="form-control" placeholder="Position">
                      </div>
                  </div> 
				 		 <div class="form-group">
                    <div class="form-group">
                        <label for="Main">Mobile</label>
                        <input type="number" name="mobile" value="<?php echo $row['mobile'];?>" class="form-control" placeholder="Mobile">
                      </div>
        ...
        <!-- /.row -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">AdminDetails Are</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
