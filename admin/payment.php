  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
       ...
       <tbody>				  										<?php 
$a=0;
$query = "SELECT * FROM `enquiry` as e join transaction as t on t.ORDERID=e.eid ORDER BY eid";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    ?>
                  ...
                  <td><?php echo $a; ?></td>
                    ...
                    <td><a href="../token.php?id=<?php echo $row['eid']; ?>"> <span class="btn btn-info">Details</span></a></td>
