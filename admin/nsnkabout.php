...
if (isset($_POST['submit'])) {
   ...
   // $filename = $_FILES['image']['name'];
    ...
    $sql = "INSERT INTO nsnkq(nq,na) values ('$qn','$as')";
    mysqli_query($connect, $sql) or die($sql);
    header('location: nsnkabout.php');
}
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['na'];?></td>
                     <td><a href="deleteabout.php?id=<?php echo $row['nsid']; ?>"> <span class="btn btn-info">Delete</span></a></td>
